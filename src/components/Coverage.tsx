...
const Coverage = () => {
  ...
  return (
    <section id="informacion" className="py-20 bg-dark-section">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-primary mb-4">Servicio Remoto</h3>
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-primary mb-4">Asesoría Personalizada</h3>
              <p className="text-muted-foreground">
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-6">
              <h3 className="text-xl font-semibold text-primary mb-4">Red de Contactos</h3>
              <p className="text-muted-foreground">
        ...
        <div className="mt-12 bg-gradient-dark rounded-2xl p-8 text-center">
